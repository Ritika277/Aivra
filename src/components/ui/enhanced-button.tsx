  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ai: "bg-gradient-ai text-white hover:shadow-glow transform hover:scale-105 shadow-ai",
        premium: "bg-gradient-to-r from-primary via-primary-glow to-ai-accent text-white hover:shadow-glow transform hover:scale-105 relative overflow-hidden",
        glass: "bg-card/30 backdrop-blur-sm border border-border/50 hover:bg-card/50 hover:shadow-elegant",
      },
      size: {
